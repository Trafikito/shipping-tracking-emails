  ...
  class Gerbora_Shipping_Tracking_Emails
  {
    ...
    */
    ...
    public function gb_meta_boxes_callback( $post ) {
      ...
      <p>
        <label for="gb_tracking_provider_id" class="input-text"><strong><?php _e( 'Provider', 'gb' )?> :</strong></label> <br>
      ...
      <p class="gb_hidden_fields">
        ...
        <input type="text" class="gb-field" name="gb_tracking_number" id="gb_tracking_number" value="<?php if ( isset( $tracking_number ) ) echo $tracking_number; ?>" />
      </p>
      <p class="tracking-link"><?php echo $this->tracking_link( $post->ID ); ?></p>

      <p class="gb_hidden_fields" >        
        <input type="text" class="gb-field" autocomplete="off" placeholder="When shipped" name="gb_date_shipped" id="gb_date_shipped"
      ...
      <div class="control-actions ">
        <a class="metabox-shipping-track" href="<?php echo $this->manage_providers; ?>"><?php _e( 'Settings', 'gb' )?></a>
          ...
          <tbody>
            <tr class="form-field form-required">
              <td scope="row">
                ...
                <br/>
                <input name="shipping_provider" type="text" id="shipping-provider" value="<?php _e( $current_provider['provider'],'gb');?>" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="80">
            ...
            <tr class="form-field form-required">
              <td scope="row">
                ...
                <br/>
                <label class="switch">
                  <input type="checkbox" name="status" value="<?php echo (strtolower($current_provider['status'])=='on')? 'on':'off'; ?>" id="status-toggle" 
            ...
            <tr class="form-field">
              <td scope="row">
                ...
                <i><br/>          
                <input name="shipping_tracking_url" id="shipping-tracking-url" type="text" value="<?php _e($current_provider['tracking_url'],'gb');?>" type="text" value="" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="80">
          ...
          <tbody>
            <tr class="form-field form-required">
              <td scope="row">
                ...
                <br/>
                <input name="shipping_provider" type="text" id="shipping-provider" value="" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="80">
                <p class="error-message-gb-plugin empty-provider">
                  <?php _e('Shipping Provider cannot be empty!','gb');?> 
                </p>
                <p class="error-message-gb-plugin duplicate-error">
            ...
            <tr class="form-field form-required">             
              <td scope="row">
                ...
                <br/>
                <label class="switch">
                  <input type="checkbox" name="status" value="on" id="status-toggle" class="checked" checked>
                  <span class="slider">
                  </span>
                </label>
              </td>
            ...
            <tr class="form-field">
              <td scope="row">
                ...
                <i>
                  <?php _e('DHL example http://dhl.com/en/express/tracking.html?AWB={{TRACKING_NUMBER}}&brand=DHL','gb');?>
                <i><br/>                           
                <input type="text" type="text" id="shipping-tracking-url" name="shipping_tracking_url" value="" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="80"/>
                <p class="tracking-num-notify"> 
                  <?php _e('{{TRACKING_NUMBER}} is not used! Url will not contain tracking number and user will have to enter it manually.','gb');?>
                </p>
                <p class="error-message-gb-plugin tracking_url_error">
    ...
    */
    public function settings_tab()
    {
      ...
      <div class="wrap gb-shippment-block">
        ...
        <a class="action-button" href="<?php echo $this->add_new_provider_path;?>"><?php _e('Add','gb');?>
        </a>
        <div class="components-notice-list delete-success" style="display:none">            
          <div class="components-notice is-success is-dismissible">
            <div class="components-notice__content">
